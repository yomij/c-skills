...
Install Codex or Claude Code skills from the published package or from GitHub repositories.
...
Options:
  ...
  --host <host>         Install for "codex" or "claude" (default: codex)
  --scope <scope>       Install into "global" or "project"
  --global              Install into the global skills directory for the selected host (default)
  --project             Install into ./.codex/skills or ./.claude/skills for the selected host
  --dest <dir>          Destination skills directory
...
Examples:
  ...
  c-skills generate-image --host claude
  ...
  c-skills install codex-account-config --project --host codex
  c-skills install generate-image --project --host claude
...
function setHost(options, host, token) {
  if (host !== 'codex' && host !== 'claude') {
    throw new Error(`Invalid value for ${token}: ${host}. Use codex or claude.`);
  }
