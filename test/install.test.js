...
test('resolves claude global installs into the user .claude directory', () => {
  assert.equal(resolveTargetRoot({ host: 'claude' }, '/tmp/demo-project'), path.resolve(path.join(os.homedir(), '.claude', 'skills')));
});
